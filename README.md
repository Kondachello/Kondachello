...
**ML-инженер · основатель и CTO** &nbsp; · &nbsp; ИТМО, КТ
...
Разрабатываю ML-системы полного цикла: обучение моделей, валидация, сервисы и инфраструктура. В проектах — прогнозирование поведения пользователей, рекомендательные системы, верификация ответов LLM и компьютерное зрение. В своём стартапе создаю систему формирования ведомостей объёмов работ и смет по 3D/BIM-моделям зданий.

**Два первых места на ML-хакатонах · 9 / 678 на Ozon E-CUP · соавтор статьи SMILES 2026**
